        ...
        <el-form :model="currentStrategy" label-width="150px">
          <div class="dialog-content">
            ...
            <el-card
              ...
              <el-row :gutter="20" v-if="currentStrategy.trade_type === 'spot'">
                <el-col :span="12">
                  <el-form-item label="活动订单数量" required>
            ...
            <el-card
              ...
              <el-row :gutter="20">
                ...
                <el-col
                  :span="12"
                  v-if="
                    currentStrategy.open_take_profit && (currentStrategy.take_profit_type === 'price' || currentStrategy.take_profit_type === 'mixed')
                  ">
              ...
              <el-row :gutter="20" v-if="currentStrategy.open_take_profit && currentStrategy.trade_type === 'futures'">
                <el-col :span="12">
                  <div>
            ...
            <el-card class="box-card" style="margin-top: 20px; margin-bottom: 20px; margin-right: 20px; margin-left: 20px">
              ...
              <el-row :gutter="20" v-if="currentStrategy.open_stop_profit">
                <el-col :span="12" v-if="currentStrategy.open_stop_profit">
                  <div>
