							...
							<el-row v-for="(precision, symbol) in symbol_precisions" :key="symbol" :gutter="20">
								<el-col :span="13">
									<el-form-item :label="`${symbol} 价格精度`" required label-width="300px" v-if="false">
										<el-input v-model.number="symbol_precisions[symbol]" placeholder="比如14.0125就填4，代表4位数" style="min-width: 250px"></el-input>
									</el-form-item>
								</el-col>
							</el-row>
						</el-card>
							...
							<el-row :gutter="20">
								<el-col :span="12">
									<el-form-item label="首单价值" required>
										<el-input type="number" :disabled="currentStrategy.is_run" v-model.number="currentStrategy.pos_value_1st">
								...
								<el-col :span="12">
									<el-form-item label="补单首单价值" required>
										<el-input type="number" :disabled="currentStrategy.is_run" v-model.number="currentStrategy.cover_order_pos_value_1st">
											<template #append>USDT</template>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row :gutter="20">
								<el-col :span="12">
									<el-form-item label="活跃订单数量" required>
										<el-input :disabled="currentStrategy.is_run" v-model.number="currentStrategy.live_order_num" placeholder="一次性挂多少个补单">
							...
							<el-row :gutter="20">
								...
								<el-col :span="12">
									<el-form-item label="补单波动" required>
										<el-input :disabled="currentStrategy.is_run" v-model.number="currentStrategy.price_pct_trigger_cover" type="number">
							...
							<el-row :gutter="20">
								<el-col :span="12">
									<el-form-item label="补单倍数" required>
										<el-input-number :disabled="currentStrategy.is_run" type="number" v-model.number="currentStrategy.cover_value_mult">
								...
								<el-col :span="12">
									<el-form-item label="加速补单百分比" required>
										<el-input :disabled="currentStrategy.is_run" type="number" v-model.number="currentStrategy.accel_cover_pct" placeholder="正数加快补单负数放慢补单">
											<template #append>%</template>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row :gutter="20">
								<el-col :span="12">
									<div>
										<el-form-item label="叠加补单" required>
											<el-radio-group :disabled="currentStrategy.is_run" v-model.number="currentStrategy.open_add_cover" class="my-radio-group">
								...
								<el-col :span="12">
									<el-form-item label="叠加补单首单价值" required v-if="currentStrategy.open_add_cover">
										<el-input type="number" :disabled="currentStrategy.is_run" v-model.number="currentStrategy.add_cover_order_pos_value_1st">
											<template #append>USDT</template>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row :gutter="20" v-if="currentStrategy.open_add_cover">
								<el-col :span="12">
									<el-form-item label="叠加补单次数" required>
										<el-input :disabled="currentStrategy.is_run" v-model.number="currentStrategy.add_all_cover_order_count">
											<template #append>次</template>
										</el-input>
									</el-form-item>
								</el-col>
								<el-col :span="12">
									<el-form-item label="叠加补单波动" required>
										<el-input :disabled="currentStrategy.is_run" v-model.number="currentStrategy.add_price_pct_trigger_cover" type="number">
											<template #append>%</template>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row :gutter="20" v-if="currentStrategy.open_add_cover">
								<el-col :span="12">
									<el-form-item label="叠加补单倍数" required>
										<el-input-number :disabled="currentStrategy.is_run" type="number" v-model.number="currentStrategy.add_cover_value_mult">
											<template #append>倍</template>
										</el-input-number>
									</el-form-item>
								</el-col>
								<el-col :span="12">
									<el-form-item label="叠加加速补单百分比" required>
										<el-input :disabled="currentStrategy.is_run" type="number" v-model.number="currentStrategy.add_accel_cover_pct" placeholder="正数加快补单负数放慢补单">
											<template #append>%</template>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row :gutter="20">
								<el-col :span="12">
									<el-form-item label="补到多少单停止" required>
										<el-input type="number" v-model.number="currentStrategy.cover_stop_num" placeholder="比如第30补单挂上后停止挂补单.不填则表示全补"></el-input>
									</el-form-item>
								</el-col>
							</el-row>
						</el-card>
