<template>
	<el-menu :default-active="route.path" class="el-menu-vertical-demo" :collapse="isClose" active-text-color="#ffd04b" background-color="rgb(47, 64, 80)" text-color="#fff" router :collapse-transition="false">
		<el-menu-item>
			<template #title><el-text tag="b" type="warning">Buzz</el-text></template>
		</el-menu-item>
		<el-menu-item index="/">
			<el-icon>
				<House />
		...
		<!-- <el-sub-menu index="/partner_plan">
            <template #title><el-icon>
                    <Paperclip />
                </el-icon><span>推广管理</span></template>
            <el-menu-item-group>
                <el-menu-item index="/partner_plan/partner_plan">交易合伙人计划</el-menu-item>
                <el-menu-item index="/partner_plan/my_cash_back">我的返现</el-menu-item>
            </el-menu-item-group>
        </el-sub-menu> -->
		<el-menu-item index="/disclaimer">
			<el-icon>
				<Notification />
			</el-icon>
			<span>免责声明</span>
